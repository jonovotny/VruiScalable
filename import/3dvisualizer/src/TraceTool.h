...
#ifndef VRUI_TraceTool_INCLUDED
#define VRUI_TraceTool_INCLUDED
...
class TraceToolFactory:public ToolFactory
	{
	friend class TraceTool;
	...
	public:
	TraceToolFactory(ToolManager& toolManager);
	static void factoryDestructor(Vrui::ToolFactory* factory)
		{
		delete factory;
		}
	virtual ~TraceToolFactory(void);
...
class TraceTool:public UtilityTool
	{
	friend class TraceToolFactory;
	...
	/* Elements: */
	static TraceToolFactory* factory; // Pointer to the factory object for this class
	...
	/* Constructors and destructors: */
	public:
	TraceTool(const Vrui::ToolFactory* sFactory,const Vrui::ToolInputAssignment& inputAssignment);
	virtual ~TraceTool(void);
