...
class PolygonMesh
	...
	virtual ~PolygonMesh(void); // Destroys polygon mesh
	...
	LineSet<MeshVertex>* createLineSet(bool getBoundaryEdges,bool getCreaseEdges) const; // Converts the boundary and/or crease edges of the polygon mesh into a line set
	template <class TriangleSetParam>
	void triangulate(TriangleSetParam& triangleSet) const; // Triangulates all faces of the polygon mesh and adds them to the given triangle set
	template <class TriangleSetParam>
	void triangulateSurface(TriangleSetParam& triangleSet,Card surfaceIndex) const; // Triangulates all faces of the polygon mesh belonging to the given surface and adds them to the given triangle set
	};
